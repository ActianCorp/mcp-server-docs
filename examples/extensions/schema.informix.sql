...
--
-- Run with:
--     dbaccess <db> schema.informix.sql
--
...
-- No explicit COMMIT: Informix (dbaccess) auto-commits each statement, and an
-- explicit COMMIT with no open transaction errors on a logged database.
