...
Extensions are supported on HCL Informix.
...
Statements run as the end user. On Informix, your statements run as the authenticated user, not as the server's service account.
...
- :material-file-code: **[Examples](examples.md)**  
  Five runnable extensions, with the configuration and schema files.
