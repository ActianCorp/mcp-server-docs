...
async def test_vector_tools_list(client, server):
...
@pytest.mark.parametrize("server", SERVER_MODES, indirect=True)
async def test_vector_tool__execute_query(client, server):
...
@pytest.mark.parametrize("server", SERVER_MODES, indirect=True)
async def test_vector_tool__list_tables(client, server):
...
@pytest.mark.parametrize("server", SERVER_MODES, indirect=True)
async def test_vector_tool__describe_table(client, server):
...
@pytest.mark.parametrize("server", SERVER_MODES, indirect=True)
async def test_vector_tool__list_functions(client, server):
